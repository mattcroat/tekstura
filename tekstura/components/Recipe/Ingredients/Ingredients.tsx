...
export function Ingredients({ ingredients }: IngredientsProps) {
  return (
    <div className="overflow-y-scroll divide-y divide-gray-800 max-h-80 scrollbar-thin dark:divide-gray-50 divide-opacity-10 dark:divide-opacity-10 print:max-h-full">
      {ingredients &&
